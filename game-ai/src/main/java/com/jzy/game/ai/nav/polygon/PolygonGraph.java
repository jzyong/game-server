...
//                    LOGGER.debug("共享边2：{}", indexConnection2.toString());
    ...
    private static Map<Polygon, List<PolygonEdge>> createSharedEdgesMap(Set<IndexConnection> indexConnections, List<Polygon> polygons) {

        Map<Polygon, List<PolygonEdge>> connectionMap = new TreeMap<Polygon, List<PolygonEdge>>((o1, o2) -> o1.getIndex() - o2.getIndex());
    ...
    private static class IndexConnection {
        ...
        public String toString() {
            return "IndexConnection [edgeVector1=" + edgeVector1 + ", edgeVector2=" + edgeVector2 + ", fromPolygonIndex=" + fromPolygonIndex + ", toPolygonIndex=" + toPolygonIndex + "]";
        }
