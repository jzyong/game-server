...
import com.jjy.game.hall.AppHall;
...
public class HallServer implements Runnable {
	...
	public HallServer(String configPath) {
		...
		// 加载连接大厅客户端配置
		ThreadPoolExecutorConfig hallClientThreatPool = FileUtil.getConfigXML(configPath,
		...
		this.hallServerCheckTimer = new GameServerCheckTimer(hall2ClusterClient, hall2GateClient,
				minaClientConfig_gate);
